...
- Linux CI выявил недостающие платформенные зависимости в npm-lock и совместное использование одного SQLite-соединения параллельными запросами в БД в памяти. Lock восстановлен из чистого дерева, а пул такой БД ограничен последовательной выдачей одного соединения. Для Docker добавлена проверка готовности фронтенда вместе с API.
